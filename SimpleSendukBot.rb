...
Telegram::Bot::Client.run(token) do |bot|
  bot.listen do |message|
    case message.text
    when '/start'
      bot.api.send_message(chat_id: message.chat.id, text: "I am SendukBesi robot, Please click on this commands /intro /waktuSolat ..Keep calm n ")
    when '/intro'
      bot.api.send_message(chat_id: message.chat.id, text: "Welcome to SendukBesi telegram robot (beta version)")
    when '/waktuSolat'
